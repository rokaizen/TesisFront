...
const TransactionCalendar = (props) => {
  ...
  const renderTransactionDetails = () => {
    if (transactionsByDate.transactionsLoading) {
      ...
      if (transactionsByDate.transactions.length > 0) {
        ...
        return (
          <div className="p-grid p-nogutter p-justify-center">
            <h4 className="color-subtitle">Error al obtener los datos.</h4>
          </div>
        );
      }
    }
  ...
  return (
    <div>
      ...
      <Dialog
        header="Detalle de Transacciones"
          ...
          <Card className="rounded-border">
            <div className='p-grid'>
              <div className='p-col-6'>
                <div className="p-card-title p-grid p-nogutter p-justify-between">Transacciones +/-</div>
                <div className="p-card-subtitle">Detalles de tus ingresos y gastos.</div>
              </div>
