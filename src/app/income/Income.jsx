...
const addIncomeValidationSchema = yup.object().shape({
  source: yup.string().required('El campo de fuente de ingresos es obligatorio').max(100, 'La fuente de ingresos debe tener un máximo de 100 caracteres.'),
  category: yup.object().required('El campo de categoría de ingresos es obligatorio'),
  notes: yup.string().max(200, 'Las notas de ingresos deben tener un máximo de 200 caracteres'),
...
const Income = (props) => {
  ...
  const deleteIncome = (data) => {
    ...
    StyledSwal.fire({
      title: 'Estas Seguro?',
      text: `Confirma para eliminar ingreso: ${data.spent_on}.`,
      icon: 'warning',
      showCancelButton: true,
      confirmButtonText: '<span class="pi pi-trash p-button-icon-left"></span><span class="p-button-text">Borrar</span>',
      cancelButtonText: '<span class="pi pi-ban p-button-icon-left"></span><span class="p-button-text">No Borrar</span>',
          ...
          axios.delete(incomeApiEndpoints.income + '/' + data.id, {})
            .then(response => {
              ...
              if (response.status === 200) {
                ...
                messages.show({
                  severity: 'success',
                  detail: 'Tu ingreso ' + data.spent_on + ' fue eliminado exitosamente.',
                  sticky: false,
                  closable: false,
                  life: 5000
                });
    ...
    axios.post(incomeApiEndpoints.income, JSON.stringify(data))
      .then(response => {
        ...
        if (response.status === 201) {
          ...
          messages.show({
            severity: 'success',
            detail: 'Tu ingreso ' + response.data.request.spent_on + ' fue agregado.',
            sticky: false,
            closable: false,
            life: 5000
          });
  ...
  const renderIncomeSummary = (data) => {
    if (data && data.length > 0) {
      ...
      return <div>
        <div className="text-center">No se encontro información de ingresos.</div>
        <hr />
      </div>
    }
  };
            ...
            <div className="p-grid">
              <div className="p-col-6">
                <div className="p-panel p-component">
                  <div className="p-panel-titlebar"><span className="color-title text-bold">Ingresos Este Mes</span>
                  </div>
              ...
              <div className="p-col-6">
                <div className="p-panel p-component">
                  <div className="p-panel-titlebar"><span className="color-title text-bold">Ingresos de Hoy</span></div>
                  <div className="p-panel-content-wrapper p-panel-content-wrapper-expanded" id="pr_id_1_content"
                    aria-labelledby="pr_id_1_label" aria-hidden="false">
                    <div className="p-panel-content">
      ...
      <div className="p-grid">
        ...
        <div className="p-col-12 p-md-6">
          <Card className="rounded-border">
            <div>
              <div className="p-card-title p-grid p-nogutter p-justify-between">Agregar Ingreso</div>
              <div className="p-card-subtitle">Ingrese informacion del ingreso a continuacion.</div>
            </div>
            <br />
            <form onSubmit={handleSubmit(submitIncome)}>
              ...
              <div className="p-fluid">
                <input type="text" ref={register} placeholder="Fuente del Ingreso" name="source" className="p-inputtext p-component p-filled" />
              ...
              <div className="p-fluid">
                <textarea ref={register} rows={5} placeholder="Notas del ingreso" name="notes" className="p-inputtext p-inputtextarea p-component p-inputtextarea-resizable" />
                <p className="text-error">{errors.notes?.message}</p>
              </div>
              <div className="p-fluid">
                <Button disabled={submitting} type="submit" label="Agregar Ingreso" icon="pi pi-plus"
        ...
        <div className="p-col-12 p-md-6">
          <Card className="rounded-border">
            <div className='p-grid'>
              <div className='p-col-6'>
                <div className="p-card-title p-grid p-nogutter p-justify-between">Vista de Ingresos</div>
                <div className="p-card-subtitle">Aquí un listado de ingresos agregados recientemente.</div>
              </div>
