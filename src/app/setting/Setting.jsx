    ...
    axios.put(currencyApiEndpoints.currency + '/' + state.user.id, JSON.stringify({ currency_id: state.currentCurrency.id }))
      .then(response => {
        ...
        if (response.status === 200) {
          ...
          messages.show({
            severity: 'success',
            detail: 'Divisa ajustada a ' + state.currentCurrency.currency_code + ' (' + state.currentCurrency.currency_name + ').',
            sticky: false,
            closable: false,
            life: 5000
          });
      ...
      .catch(error => {
        ...
        if (error.response.status === 422) {
          ...
          messages.show({
            severity: 'error',
            detail: 'Divisa seleccionada es la divisa actual. No se realizaron cambios.',
            sticky: true,
            closable: true,
            life: 5000
          });
      ...
      <div className="p-grid">
        ...
        <div className="p-col-12 p-md-6">
          <Card className="rounded-border">
            <div>
              <div className="p-card-title p-grid p-nogutter p-justify-between">Ajustes</div>
            ...
            <div className="p-grid p-nogutter p-justify-between">
              ...
              <h3>
                <Button label="Cambiar" icon="pi pi-refresh"
            ...
            <div className="p-card-footer p-fluid">
              <Button label="Actualizar" className="" icon="pi pi-save" onClick={() => submitSetting()} />
            </div>
          </Card>
        </div>
        ...
        <div className="p-col-12 p-md-6">
          <Card className="rounded-border">
            <div>
              <div className="p-card-title p-grid p-nogutter p-justify-between">Ajustes de interfaz</div>
            ...
            <div className="p-grid p-nogutter p-justify-between">
              ...
              <h3 className="color-highlight p-col-4">
                {state.layoutColorMode === 'dark' ? 'Oscuro' : 'Claro'}
              </h3>
              <h3>
            ...
            <div className="p-grid p-nogutter p-justify-between">
              ...
              <h3 className="color-highlight p-col-4">
                {state.layoutMode === 'static' ? 'Estatico' : 'Cubrir'}
              </h3>
              <h3>
                <Button label="Toggle" icon="pi pi-refresh"
                  className="p-button-rounded p-button-raised p-button-secondary"
