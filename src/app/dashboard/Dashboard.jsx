...
const addExpenseValidationSchema = yup.object().shape({
  ...
  amount: yup.string().required('Monto de Gasto Requerido'),
  spent_on: yup.string().required('Gastado En Requerido').max(100, 'Gastado en debe tener como maximo 100 caracteres'),
  remarks: yup.string().max(200, 'Anotaciones deben tener como maximo 200 caracteres'),
});
...
const Dashboard = (props) => {
    ...
    axios.post(expenseApiEndpoints.expense, JSON.stringify(data))
      .then(response => {
        ...
        if (response.status === 201) {
          ...
          messages.show({
            severity: 'success',
            detail: 'Gasto ' + response.data.request.spent_on + ' agregado.',
            sticky: false,
            closable: false,
            life: 5000
          });
  ...
  const renderRecentExpense = () => {
    if (recentExpense.expenseLoading) {
      ...
      if (recentExpense.expense.length > 0) {
        ...
        return (
          <div className="p-grid p-nogutter p-justify-center">
            <h4 className="color-subtitle">Esperando tus gastos ...</h4>
          </div>
        );
      }
    }
  ...
  const renderRecentIncome = () => {
    if (recentIncome.incomeLoading) {
      ...
      if (recentIncome.income.length > 0) {
        ...
        return (
          <div className="p-grid p-nogutter p-justify-center">
            <h4 className="color-subtitle">Agrega nuevos ingresos</h4>
          </div>
        );
      }
    }
  ...
  const renderSummary = (data) => {
    if (data && data.length > 0) {
      ...
      return <div>
        <div className="text-center">No se encontro informacion de Gasto.</div>
        <hr />
      </div>
    }
  };
            ...
            <div className="p-grid">
              <div className="p-col-6 p-md-3">
                <div className="p-panel p-component">
                  <div className="p-panel-titlebar"><span className="color-title text-bold">Gastos Mes Pasado</span>
                  </div>
              ...
              <div className="p-col-6 p-md-3">
                <div className="p-panel p-component">
                  <div className="p-panel-titlebar"><span className="color-title text-bold">Gastos Mes Actual</span></div>
                  <div className="p-panel-content-wrapper p-panel-content-wrapper-expanded" id="pr_id_1_content"
                    aria-labelledby="pr_id_1_label" aria-hidden="false">
                    <div className="p-panel-content">
              ...
              <div className="p-col-6 p-md-3">
                <div className="p-panel p-component">
                  <div className="p-panel-titlebar"><span className="color-title text-bold">Ingresos Mes Pasado</span>
                  </div>
                  <div className="p-panel-content-wrapper p-panel-content-wrapper-expanded" id="pr_id_1_content"
                    aria-labelledby="pr_id_1_label" aria-hidden="false">
                    <div className="p-panel-content">
              ...
              <div className="p-col-6 p-md-3">
                <div className="p-panel p-component">
                  <div className="p-panel-titlebar"><span className="color-title text-bold">Ingresos Mes Actual</span></div>
                  <div className="p-panel-content-wrapper p-panel-content-wrapper-expanded" id="pr_id_1_content"
                    aria-labelledby="pr_id_1_label" aria-hidden="false">
                    <div className="p-panel-content">
      ...
      <div className="p-grid">
        ...
        <div className="p-col-12 p-md-6 p-lg-4">
          <Card className="rounded-border">
            <div>
              <div className="p-card-title p-grid p-nogutter p-justify-between">Informacion Gasto</div>
              <div className="p-card-subtitle">Ingrese la informacion de su gasto.</div>
            </div>
            <br />
            <form onSubmit={handleSubmit(submitExpense)}>
              ...
              <div className="p-fluid">
                <textarea ref={register} rows={5} placeholder="Anotaciones" name="remarks" className="p-inputtext p-inputtextarea p-component p-inputtextarea-resizable" />
        ...
        <div className="p-col-12 p-md-6 p-lg-4">
          <Card className="rounded-border">
            <div>
              <div className="p-card-title p-grid p-nogutter p-justify-between">Gastos Recientes -</div>
              <div className="p-card-subtitle">Estos son algunos gastos que has realizado.</div>
            </div>
            <br />
            <div>
              {renderRecentExpense()}
        ...
        <div className="p-col-12 p-md-6 p-lg-4">
          <Card className="rounded-border">
            <div>
              <div className="p-card-title p-grid p-nogutter p-justify-between">Ingresos Recientes +</div>
              <div className="p-card-subtitle">Estos son algunos ingresos que has agregado.</div>
            </div>
            <br />
            <div>
              {renderRecentIncome()}
